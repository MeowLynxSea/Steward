...
- Skills are loaded from the shared `~/.steward/skills` root, may refresh between turns if the on-disk snapshot changes, and desktop chat turns inject every installed skill unless the user disabled it in Settings.
