...
//!
//! ```ignore
//! use steward_core::tools::wasm::{WasmToolRuntime, WasmRuntimeConfig, WasmToolWrapper};
//! use steward_core::tools::wasm::Capabilities;
//! use std::sync::Arc;
//!
//! // Create runtime
...
pub const WIT_CHANNEL_VERSION: &str = WIT_TOOL_VERSION;
