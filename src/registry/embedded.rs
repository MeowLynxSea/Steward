...
//!
//! When Steward is distributed as a pre-built binary without a source tree,
...
/// Raw JSON generated by build.rs from `registry/{tools,mcp-servers}/*.json` and `_bundles.json`.
...
/// Load all embedded extension manifests, keyed by `"tools/<name>"` or `"mcp-servers/<name>"`.
