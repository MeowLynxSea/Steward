...
/// Convert Steward `ChatMessage` list into Bedrock system blocks + messages.
///
...
/// Build Bedrock `ToolConfiguration` from Steward tool definitions.
...
/// Map Bedrock `StopReason` to Steward `FinishReason`.
