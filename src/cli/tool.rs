...
pub enum ToolCommand {
    ...
    Install {
        ...
        /// Target directory for installation (default: ~/.ironcowork/tools/)
        #[arg(short, long)]
    ...
    List {
        /// Directory to list tools from (default: ~/.ironcowork/tools/)
        #[arg(short, long)]
        dir: Option<PathBuf>,
    ...
    Remove {
        ...
        /// Directory to remove tool from (default: ~/.ironcowork/tools/)
        #[arg(short, long)]
        dir: Option<PathBuf>,
    },
    ...
    Info {
        ...
        /// Directory to look for tool (default: ~/.ironcowork/tools/)
        #[arg(short, long)]
        dir: Option<PathBuf>,
...
async fn list_tools(dir: Option<PathBuf>, verbose: bool) -> anyhow::Result<()> {
    ...
    if !tools_dir.exists() {
        ...
        println!("Install a tool with: ironcowork tool install <path>");
        return Ok(());
    }
    ...
    let setup = caps.setup.ok_or_else(|| {
        anyhow::anyhow!(
            "Tool '{}' has no setup configuration.\n\
             ...
             Try 'ironcowork tool auth {}' for OAuth-based authentication.",
            name,
            name
        )
    })?;
...
mod tests {
    ...
    fn test_default_tools_dir() {
        ...
        assert!(dir.to_string_lossy().contains(".ironcowork"));
