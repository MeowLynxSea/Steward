# Steward ↔ OpenClaw Feature Parity Matrix

This document tracks feature parity between Steward (Rust implementation) and OpenClaw (TypeScript reference implementation). Use this to coordinate work across developers.
...
| Feature | OpenClaw | Steward | Notes |
|---------|----------|----------|-------|
...
| Channel | OpenClaw | Steward | Priority | Notes |
|---------|----------|----------|----------|-------|
| CLI/TUI | ✅ | ✅ | - | Ratatui-based TUI |
| HTTP webhook | ✅ | ✅ | - | axum with secret validation |
| REPL (simple) | ✅ | ✅ | - | For testing |
| WASM channels | ❌ | ✅ | - | Steward innovation; host resolves owner scope vs sender identity |
...
| Feature | OpenClaw | Steward | Notes |
|---------|----------|----------|-------|
| DM pairing codes | ✅ | ✅ | `steward pairing list/approve`, host APIs |
...
| Command | OpenClaw | Steward | Priority | Notes |
|---------|----------|----------|----------|-------|
...
| Feature | OpenClaw | Steward | Notes |
|---------|----------|----------|-------|
| Pi agent runtime | ✅ | ➖ | Steward uses custom runtime |
...
| Provider | OpenClaw | Steward | Priority | Notes |
|----------|----------|----------|----------|-------|
...
| Tinfoil | ❌ | ✅ | - | Private inference provider (Steward-only) |
...
| Feature | OpenClaw | Steward | Priority | Notes |
|---------|----------|----------|----------|-------|
...
| Workspace-relative install | ✅ | ✅ | ~/.steward/tools/ |
...
| Hot-reload | ✅ | ❌ | |
| Legacy migration | ✅ | ➖ | |
| State directory | ✅ `~/.openclaw-state/` | ✅ `~/.steward/` | |
...
| Gemini embeddings | ✅ | ❌ | |
| Local embeddings | ✅ | ❌ | |
| SQLite-vec backend | ✅ | ❌ | Steward uses PostgreSQL |
...
| DM pairing verification | ✅ | ✅ | steward pairing approve, host APIs |
...
| LD*/DYLD* validation | ✅ | ❌ | |
| Path traversal prevention | ✅ | ✅ | Including config includes (OC-06) + workspace-only tool allowlists |
...
Steward intentionally differs from OpenClaw in these ways:
